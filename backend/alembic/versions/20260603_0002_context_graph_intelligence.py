...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("node_type", postgresql.ENUM(name="graph_node_type", create_type=False),
                  nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(name="ai_decision_status", create_type=False),
    ...
    op.create_table(
        ...
        sa.Column("target_node_id", postgresql.UUID(as_uuid=True),
                  sa.ForeignKey("graph_nodes.id", ondelete="CASCADE"), nullable=False),
        sa.Column("edge_type", postgresql.ENUM(name="graph_edge_type", create_type=False),
                  nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("study_id", postgresql.UUID(as_uuid=True),
                  sa.ForeignKey("studies.id", ondelete="SET NULL"), nullable=True),
        sa.Column("lineage_type", postgresql.ENUM(name="data_lineage_type", create_type=False),
                  nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(name="validation_evidence_status", create_type=False),
                  nullable=False),
